...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ciclista', fields ['token']
        db.create_unique(u'xbapp_ciclista', ['token'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ciclista', fields ['token']
        db.delete_unique(u'xbapp_ciclista', ['token'])
    ...
    models = {
        ...
        u'xbapp.ciclista': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'922b6926-3ea3-11e3-a7ec-701a0416ad73'", 'unique': 'True', 'max_length': '36'}),
