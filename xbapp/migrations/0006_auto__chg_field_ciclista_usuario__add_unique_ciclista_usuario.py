...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ciclista.usuario'
        db.alter_column(u'xbapp_ciclista', 'usuario_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Ciclista', fields ['usuario']
        db.create_unique(u'xbapp_ciclista', ['usuario_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ciclista', fields ['usuario']
        db.delete_unique(u'xbapp_ciclista', ['usuario_id'])


        # Changing field 'Ciclista.usuario'
        db.alter_column(u'xbapp_ciclista', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
