...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ruta.longitud'
        db.add_column(u'xbapp_ruta', 'longitud',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Ruta.desplazamiento'
        db.add_column(u'xbapp_ruta', 'desplazamiento',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ruta.longitud'
        db.delete_column(u'xbapp_ruta', 'longitud')

        # Deleting field 'Ruta.desplazamiento'
        db.delete_column(u'xbapp_ruta', 'desplazamiento')
    ...
    models = {
        ...
        u'xbapp.ciclista': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'adefb03a-3ebd-11e3-b0a3-701a0416ad73'", 'unique': 'True', 'max_length': '36'}),
