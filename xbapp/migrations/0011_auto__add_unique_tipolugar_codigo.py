...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TipoLugar', fields ['codigo']
        db.create_unique(u'xbapp_tipolugar', ['codigo'])


    def backwards(self, orm):
        # Removing unique constraint on 'TipoLugar', fields ['codigo']
        db.delete_unique(u'xbapp_tipolugar', ['codigo'])
    ...
    models = {
        ...
        u'xbapp.ciclista': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'d34d8462-3ec0-11e3-9e11-701a0416ad73'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'xbapp.tipolugar': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
